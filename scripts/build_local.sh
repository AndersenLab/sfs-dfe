...
# Fetch Tajima's D
if [ ! -s annotation/WI.${CENDR_RELEASE}.tajima.bed.gz ];
then
...
if [ ! -s df_outgroup/ECA701.tsv.gz ];
then
    parallel -P 0 --verbose generate {} ::: I II III IV V X MtDNA ::: ECA701
    cat ${base_path}/data/tmp/ECA701_I.tsv ${base_path}/data/tmp/ECA701_II.tsv ${base_path}/data/tmp/ECA701_III.tsv ${base_path}/data/tmp/ECA701_IV.tsv ${base_path}/data/tmp/ECA701_V.tsv ${base_path}/data/tmp/ECA701_X.tsv ${base_path}/data/tmp/ECA701_MtDNA.tsv | pigz > ${base_path}/data/df_outgroup/ECA701.tsv.gz
